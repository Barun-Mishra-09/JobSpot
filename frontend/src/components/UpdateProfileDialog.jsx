                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3 space-y-2">
                    <input
                      ...
                      onChange={fileChangeHandler}
                      className="w-full border-2 focus:border-[#4A38C2] rounded-md p-2 text-sm sm:text-base outline-none cursor-pointer"
                    />
                    {typeof input.resume === "string" && (
                      ...
                      >
                        View Uploaded Resume ({getFileName(input.resume)})
                      </a>
                    )}
                  </div>
                </div>
