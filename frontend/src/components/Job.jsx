...
const Job = ({ job }) => {
  ...
  return (
    <motion.div
      ...
      className="p-3 sm:p-4 lg:p-5 rounded-lg bg-gradient-to-br from-blue-50 via-pink-50 to-violet-50 w-full border border-violet-400 mb-2 lg:mb-2 md:mb-2 sm:mb-2 border-b-8 rounded-b-3xl border-violet-400 min-h-[380px] flex flex-col justify-between"
    >
      ...
      <div className="flex items-center gap-3 my-2">
        <motion.div
          ...
          className="w-14 h-14 flex  items-center justify-center rounded-full bg-white shadow-md border-2 border-purple-500 p-2"
        >
          <Avatar>
            <AvatarImage
                ...
                <Button
                  ...
                  className={`${
                    isSaved
                      ...
                      : "bg-[#8A2BE2]"
                  } bg-gradient-to-r from-[#F83002] to-[#6D28D9]  hover:from-[#FF7A3C] hover:to-[#7C3AED] w-full sm:w-auto lg:w-auto md:w-full text-sm px-3 py-2 text-center`}
                >
