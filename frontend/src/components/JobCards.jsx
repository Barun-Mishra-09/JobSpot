...
const JobCards = ({ job }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.08, boxShadow: "0px 10px 20px rgba(0,0,0,0.15)" }}
      transition={{ duration: 0.3 }}
      className="p-5 rounded-2xl shadow-lg bg-gradient-to-r from-[#ede9fe] via-[#e0e7ff] to-[#dbeafe] border border-[#6D28D9] border-b-8 border-violet-500
